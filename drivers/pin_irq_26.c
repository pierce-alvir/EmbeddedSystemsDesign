...
#define PIN_IRQ_26_RESETS  ( RESETS_RESET_IO_BANK0_MASK \
...
void configure_pin_irq_26()
{
	resets -> clr_reset = PIN_IRQ_26_RESETS;
	while( (resets -> reset_done & PIN_IRQ_26_RESETS) != PIN_IRQ_26_RESETS);
